...
exe "let s:bg_byellow = ' ".s:vmode."bg=".s:byellow ."'"
...
exe "let s:fg_byellow = ' ".s:vmode."fg=".s:byellow    ."'"
...
exe "hi! NonText"         .s:fg_orange      .s:bg_none        .s:fmt_none
"exe "hi! StatusLine"      .s:fg_linenr      .s:bg_background  .s:fmt_bold
exe "hi! StatusLine"      .s:fg_orange      .s:bg_background  .s:fmt_bold
exe "hi! StatusLineNC"    .s:fg_window      .s:bg_comment     .s:fmt_revr
exe "hi! TabLine"         .s:fg_foreground  .s:bg_darkcolumn  .s:fmt_revr
exe "hi! Visual"          .s:fg_none        .s:bg_selection   .s:fmt_none
exe "hi! Search"          .s:fg_byellow  .s:bg_none      .s:fmt_undb
...
exe "hi! cursor"          .s:fg_background  .s:bg_orange     .s:fmt_bold
